  ...
  return (
    ...
    >
      <div id="random-restaurant">
        {/* <h2 id="random-restaurant_name">Where to eat...?</h2> */}
        ...
        <ul className="random-restaurant_details">
          <li>
            ...
            <a href="{restaurants[1].website}"> Menu</a>
            {restaurants[1].cuisine} Cuisine
          </li>
          <li>
            ...
            Neighborhood:
            <a href="{restaurants[1].gmaps}">{restaurants[1].neighborhood}</a>
          </li>
        </ul>
      </div>
    </section>
